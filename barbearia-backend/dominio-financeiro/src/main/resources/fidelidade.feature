Funcionalidade: Gestão de Pontos de Fidelidade
  ...
  Cenário: Cliente acumula pontos de múltiplos serviços em um único atendimento
    Dado um cliente com <pontos_iniciais> pontos de fidelidade
    E que o serviço de "corte" vale <pontos_corte> pontos
    E que o serviço de "barba" vale <pontos_barba> pontos
    Quando o cliente finaliza um atendimento com os serviços de "corte" e "barba"
    Então seu saldo final de pontos de fidelidade deve ser <pontos_finais>
